                ...
                {recentActivities.map((activity) => (
                  <ListItem key={activity.id} sx={{ px: 0 }}>
                    <ListItemAvatar>
                      ...
                      >
                        {activity.type === 'health' ? <LocalHospital /> : <Agriculture />}
                      </Avatar>
                    </ListItemAvatar>
                    <ListItemText
                      primary={
            ...
            <CardContent>
              ...
              <Box sx={{ mb: 3 }}>
                <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 1 }}>
                  ...
                  <Typography variant="body2">{healthyAnimals}/{totalAnimals}</Typography>
                </Box>
                <LinearProgress 
                  variant="determinate" 
                  value={totalAnimals > 0 ? (healthyAnimals / totalAnimals) * 100 : 0}
              ...
              <Box>
                ...
                <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 1 }}>
                  <Chip label="Vaccination Due (3)" size="small" color="warning" />
                  <Chip label="Health Checkup (2)" size="small" color="info" />
                </Box>
              </Box>
            </CardContent>
          </Card>
